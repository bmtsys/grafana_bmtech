...
import (
	...
	"github.com/grafana/grafana_bmtech/pkg/cmd/grafana-cli/commands"
	"github.com/grafana/grafana_bmtech/pkg/cmd/grafana-cli/logger"
	"github.com/grafana/grafana_bmtech/pkg/cmd/grafana-cli/services"
	"github.com/grafana/grafana_bmtech/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/grafana/grafana_bmtech"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
