...
- **Graph**: Support for shared tooltip on all graphs as you hover over one graph. [#1578](https://github.com/grafana/grafana_bmtech/pull/1578), [#6274](https://github.com/grafana/grafana_bmtech/pull/6274)
